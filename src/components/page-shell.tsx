  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <a
        ...
        className="fixed bottom-5 right-5 z-40 grid place-items-center w-14 h-14 rounded-full bg-[color:var(--emerald)] text-white shadow-[var(--shadow-elegant)] hover:scale-105 transition-transform"
  ...
  return (
    <section className="bg-[var(--gradient-dark)] text-white">
      <div className="mx-auto max-w-[1320px] px-5 md:px-8 py-20 md:py-28 text-center">
        {eyebrow && <div className="text-xs font-semibold tracking-[0.2em] uppercase text-[color:var(--gold)] mb-4">{eyebrow}</div>}
