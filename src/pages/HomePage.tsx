    ...
    <PageShell>
        ...
        <div className="mx-auto max-w-[1320px] px-5 md:px-8">
          ...
          <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-4">
            {services.map(({ icon: Icon, title, desc }) => (
              <div key={title} className="group p-6 rounded-xl bg-card border border-border hover:border-gold hover:shadow-elegant transition-all">
      ...
      <section className="py-20 md:py-28 bg-background-alt">
        <div className="mx-auto max-w-[1320px] px-5 md:px-8">
          ...
          <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-4">
            {products.map((p) => (
              <article key={p.name} className="rounded-xl bg-card border border-border overflow-hidden flex flex-col hover:shadow-elegant transition-shadow">
